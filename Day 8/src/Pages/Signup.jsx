...
const Signup =()=>{
  ...
  const [errors,setErrors] = useState({})
    ...
    return(
        <div className="flex items-center w-full min-h-screen justify-center bg-blue-200">
            ...
            <form onSubmit={handleSubmit} class="relative flex flex-col m-6 space-y-0 bg-white shadow-2xl rounded-2xl md:flex-row md:space-x-0">
                ...
                <h1 className="text-center text-2xl font-bold font-serif text-2xl">Calculate Your Tax</h1>
                    ...
                    <div className="py-4 justify-between">
                        ...
                        name="email"
                        value={signup.email}
                        class="w-full rounded  border-slate-600 font-serif hover:bg-blue-200 p-2 hover:placeholder:text-black outline-none"
                    ...
                    <div className="py-4 justify-between">
                        ...
                        value={signup.name}
                        name="name"
                        class="w-full rounded border-slate-600  hover:bg-blue-200 p-2 hover:placeholder:text-black outline-none "
                        onChange={handleChange} ></input>
                 ...
                 font-bold font-serif hover:text-black hover:bg-blue-200 " type="submit">
                    Sign up
                </button>

                <span class="flex justify-center items-center">or</span>
                <button class=" flex gap-4 justify-center font-serif w-full bg-black  text-white font-bold p-2 rounded-lg hover:bg-blue-200  hover:text-black ">
                <FcGoogle class="mt-1"/>
                    Sign up with Google
                </button>
                <div class="flex   cursor-pointer">
                <span>Already have an account?{" "}
                <p className="hover:underline hover:text-blue-200" onClick={()=>nav('/')}>Login</p></span>
                </div>
                </div>
