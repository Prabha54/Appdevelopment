  ...
  return (
    <div class="flex  items-center justify-center  min-h-screen bg-blue-400">
      ...
      >
        ...
        <Toaster/>
          <span className="mb-3 text-4xl font-bold text-blue-400">Hello!!!</span>
          ...
          {/*  <div class="mr-24">
            ...
            <span class="font-serif text-md cursor-pointer hover:text-blue-400 hover:underline" onClick={notify}>
              Forget password ?
            </span>
          </div>
          <div class="flex flex-col space-y-2">
              ...
              class="w-full bg-black text-white p-2 rounded-lg mt-5
                 font-bold font-serif hover:text-black hover:bg-blue-400"
            >
              Sign in
            </button>
            ...
            <button class=" flex gap-4 justify-center w-full bg-black  font-serif text-white font-bold p-2 rounded-lg hover:bg-blue-400  hover:text-black ">
              <FcGoogle class="mt-1" />
              Sign in with Google
            </button>
          </div>
