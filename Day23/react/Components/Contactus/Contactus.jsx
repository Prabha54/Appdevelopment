...
const Contactus = () => {
  ...
  const [questions] = useState([
    ...
    {
      id: 3,
      question: "Can I use the income tax calculator for my business taxes?",
      answer: "Yes, our income tax calculator can be used for both individual and business taxes."
    }
  ]);
